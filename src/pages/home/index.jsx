...
const Home = () => {
    return (
        <article>
            <h1>El barrio mas cool ya no es Palermo: segun el NY times el trono paso de manos</h1>
            <h3>No solo por los negocios gastronomicos, la arquitectura y otros detalles lo convierten en "peculiar"</h3>
            <ul>
